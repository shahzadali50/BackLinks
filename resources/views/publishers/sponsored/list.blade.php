        ...
        <div class="card" id="ticketsList">
            <div class="card-header border-0">
                <div class="d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1">Sponsored posts sales</h5>
                    <div class="flex-shrink-0">
                        <div class="d-flex flex-wrap gap-2">
                            {{-- <button class="btn btn-danger add-btn" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add Web</button> --}}
                    ...
                    <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                        <thead>
                            <tr>
                                ...
                                <th class="sort" data-sort="Web">Web</th>
                                <th class="sort" data-sort="Destination_Url">Destination URL</th>
                                <th class="sort" data-sort="DOS">Date of sale</th>
                        ...
                        <tbody class="list form-check-all" id="ticket-list-data">
                            <tr>
                                ...
                                <td class="web">Error message when placing an order?</td>
                                <td class="destination_url">Tonya Noble</td>
                                <td class="dos">08 Dec, 2021</td>
                                <td class="deadline">25 Jan, 2022</td>
                                <td class="credit">50</td> <!-- Assuming 'Credit' value -->
                                <td class="action">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li><a class="dropdown-item remove-item-btn" data-bs-toggle="modal" href="#deleteOrder"><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
