                    ...
                    <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                        <thead>
                            <tr>
                                ...
                                <th class="sort" data-sort="shopping_cart">Shopping cart</th>
                                <th class="sort" data-sort="status">Status</th>
                                <th class="sort" data-sort="amount">Amount</th>
                                <th class="sort" data-sort="campaing_extra">Campaing extra</th>
                                <th class="sort" data-sort="bill">Bill</th>
                        ...
                        <tbody class="list form-check-all" id="ticket-list-data">
                            <tr>
                                ...
                                <td class="priority"><span class="badge bg-info text-uppercase">progress</span>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><button class="dropdown-item" onclick="location.href = 'apps-tickets-details';"><i class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                    View</button></li>
                            ...
                            <tr>
                                ...
                                <td class="id"><a href="javascript:void(0);" onclick="ViewTickets(this)" data-id="001" class="fw-medium link-primary">#VLZ001</a></td>
                                <td class="tasks_name">shahzad message when placing an orders?</td>
                                <td class="client_name">ali Noble</td>
                            ...
                            <tr>
                                ...
                                <td class="id"><a href="javascript:void(0);" onclick="ViewTickets(this)" data-id="001" class="fw-medium link-primary">#VLZ001</a></td>
                                <td class="tasks_name">Hamzaa message when placing an orders?</td>
                                <td class="client_name">School Noble</td>
                                <td class="assignedto">James Morris</td>
                                <td class="create_date">08 Dec, 2021</td>
                                <td class="due_date">25 Jan, 2022</td>
                                <td class="priority"><span class="badge bg-danger text-uppercase">High</span>
